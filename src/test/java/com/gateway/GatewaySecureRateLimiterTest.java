...
public class GatewaySecureRateLimiterTest {
    ...
    public static void init() {
        ...
        System.setProperty("spring.cloud.gateway.routes[0]" +
                ".filters[1].args.redis-rate-limiter.replenishRate", "1");
        System.setProperty("spring.cloud.gateway.routes[0]" +
                ".filters[1].args.redis-rate-limiter.burstCapacity", "60");
        System.setProperty("spring.cloud.gateway.routes[0]" +
                ".filters[1].args.redis-rate-limiter.requestedTokens", "15");
    ...
    public void testAccountService() {
        ...
        ResponseEntity<Account> responseEntity = template.exchange("/account/{id}",
                HttpMethod.GET,
                entity,
                Account.class,
                1);
